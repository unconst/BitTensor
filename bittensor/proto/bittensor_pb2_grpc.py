  ...
  """
    ...
    """
        self.Spike = channel.unary_unary(
            '/Bittensor/Spike',
            request_serializer=bittensor_dot_proto_dot_bittensor__pb2.
            SpikeRequest.SerializeToString,
            response_deserializer=bittensor_dot_proto_dot_bittensor__pb2.
            SpikeResponse.FromString,
        )
        self.Grade = channel.unary_unary(
            '/Bittensor/Grade',
            request_serializer=bittensor_dot_proto_dot_bittensor__pb2.
            GradeRequest.SerializeToString,
            response_deserializer=bittensor_dot_proto_dot_bittensor__pb2.
            GradeResponse.FromString,
        )
    ...
    rpc_method_handlers = {
        'Spike':
            grpc.unary_unary_rpc_method_handler(
                servicer.Spike,
                request_deserializer=bittensor_dot_proto_dot_bittensor__pb2.
                SpikeRequest.FromString,
                response_serializer=bittensor_dot_proto_dot_bittensor__pb2.
                SpikeResponse.SerializeToString,
            ),
        'Grade':
            grpc.unary_unary_rpc_method_handler(
                servicer.Grade,
                request_deserializer=bittensor_dot_proto_dot_bittensor__pb2.
                GradeRequest.FromString,
                response_serializer=bittensor_dot_proto_dot_bittensor__pb2.
                GradeResponse.SerializeToString,
            ),
    }
