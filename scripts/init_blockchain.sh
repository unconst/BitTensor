...
cleos wallet import -n bittensorwal --private-key 5JpWT4ehouB2FF9aCfdfnZ5AwbQbTtHBAwebRXt94FmjyhXwL4K
# Active key for bittensorwal wallet
cleos wallet import -n bittensorwal --private-key 5JD9AGTuTeD5BXZwGQ5AtwBqHK21aHmYnTetHgk1B3pjj7krT8N

# * Replace "bittensorwal" by your own wallet name when you start your own project
