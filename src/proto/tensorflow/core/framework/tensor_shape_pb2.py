...
# source: proto/tensorflow/core/framework/tensor_shape.proto
...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='proto/tensorflow/core/framework/tensor_shape.proto',
  package='bolttensorflow',
  syntax='proto3',
  serialized_options=None,
  serialized_pb=_b('\n2proto/tensorflow/core/framework/tensor_shape.proto\x12\x0e\x62olttensorflow\"~\n\x10TensorShapeProto\x12\x31\n\x03\x64im\x18\x02 \x03(\x0b\x32$.bolttensorflow.TensorShapeProto.Dim\x12\x14\n\x0cunknown_rank\x18\x03 \x01(\x08\x1a!\n\x03\x44im\x12\x0c\n\x04size\x18\x01 \x01(\x03\x12\x0c\n\x04name\x18\x02 \x01(\tb\x06proto3')
)
...
_TENSORSHAPEPROTO_DIM = _descriptor.Descriptor(
  name='Dim',
  full_name='bolttensorflow.TensorShapeProto.Dim',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='size', full_name='bolttensorflow.TensorShapeProto.Dim.size', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='name', full_name='bolttensorflow.TensorShapeProto.Dim.name', index=1,
...
_TENSORSHAPEPROTO = _descriptor.Descriptor(
  ...
  full_name='bolttensorflow.TensorShapeProto',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='dim', full_name='bolttensorflow.TensorShapeProto.dim', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='unknown_rank', full_name='bolttensorflow.TensorShapeProto.unknown_rank', index=1,
