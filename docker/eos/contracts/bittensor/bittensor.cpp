...
CONTRACT bittensor : public eosio::contract {
  private:
  ...
  public:
    ...
    // constructor
    bittensor( name receiver, name code, datastream<const char*> ds ):
...
EOSIO_DISPATCH( bittensor, (update) )
